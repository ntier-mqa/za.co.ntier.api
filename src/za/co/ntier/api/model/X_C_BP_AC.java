...
/** Generated Model for C_BP_AC
 *  @author iDempiere (generated)
 *  @version Release 12 - $Id$ */
@org.adempiere.base.Model(table="C_BP_AC")
public class X_C_BP_AC extends PO implements I_C_BP_AC, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_C_BP_AC (Properties ctx, int C_BP_AC_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, C_BP_AC_ID, trxName, virtualColumns);
      /** if (C_BP_AC_ID == 0)
        {
        } */
    }
    ...
    /** Standard Constructor */
    public X_C_BP_AC (Properties ctx, String C_BP_AC_UU, String trxName)
    {
      super (ctx, C_BP_AC_UU, trxName);
      /** if (C_BP_AC_UU == null)
        {
        } */
    }
    ...
    /** Standard Constructor */
    public X_C_BP_AC (Properties ctx, String C_BP_AC_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, C_BP_AC_UU, trxName, virtualColumns);
      /** if (C_BP_AC_UU == null)
        {
        } */
    }
    ...
    /** Load Constructor */
    public X_C_BP_AC (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_C_BP_AC[")
	...
	/** Set AC.
		@param C_BP_AC_ID AC
	*/
	public void setC_BP_AC_ID (int C_BP_AC_ID)
	{
		if (C_BP_AC_ID < 1)
			set_ValueNoCheck (COLUMNNAME_C_BP_AC_ID, null);
		else
			set_ValueNoCheck (COLUMNNAME_C_BP_AC_ID, Integer.valueOf(C_BP_AC_ID));
	}

	/** Get AC.
		@return AC	  */
	public int getC_BP_AC_ID()
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_BP_AC_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set C_BP_AC_UU.
		@param C_BP_AC_UU C_BP_AC_UU
	*/
	public void setC_BP_AC_UU (String C_BP_AC_UU)
	{
		set_ValueNoCheck (COLUMNNAME_C_BP_AC_UU, C_BP_AC_UU);
	}

	/** Get C_BP_AC_UU.
		@return C_BP_AC_UU	  */
	public String getC_BP_AC_UU()
	{
		return (String)get_Value(COLUMNNAME_C_BP_AC_UU);
	}
