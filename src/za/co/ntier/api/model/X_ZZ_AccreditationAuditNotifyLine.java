...
/** Generated Model for ZZ_AccreditationAuditNotifyLine
 *  @author iDempiere (generated)
 *  @version Release 12 - $Id$ */
@org.adempiere.base.Model(table="ZZ_AccreditationAuditNotifyLine")
public class X_ZZ_AccreditationAuditNotifyLine extends PO implements I_ZZ_AccreditationAuditNotifyLine, I_Persistent
{
    ...
    public X_ZZ_AccreditationAuditNotifyLine (Properties ctx, int ZZ_AccreditationAuditNotifyLine_ID, String trxName)
    {
      super (ctx, ZZ_AccreditationAuditNotifyLine_ID, trxName);
      /** if (ZZ_AccreditationAuditNotifyLine_ID == 0)
        {
			setZZ_AccreditationAuditNotifyLine_ID (0);
			setZZ_AccreditationAuditNotifyLine_UU (null);
        } */
    }

    /** Standard Constructor */
    public X_ZZ_AccreditationAuditNotifyLine (Properties ctx, int ZZ_AccreditationAuditNotifyLine_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZ_AccreditationAuditNotifyLine_ID, trxName, virtualColumns);
      /** if (ZZ_AccreditationAuditNotifyLine_ID == 0)
        {
			setZZ_AccreditationAuditNotifyLine_ID (0);
			setZZ_AccreditationAuditNotifyLine_UU (null);
    ...
    /** Standard Constructor */
    public X_ZZ_AccreditationAuditNotifyLine (Properties ctx, String ZZ_AccreditationAuditNotifyLine_UU, String trxName)
    {
      super (ctx, ZZ_AccreditationAuditNotifyLine_UU, trxName);
      /** if (ZZ_AccreditationAuditNotifyLine_UU == null)
        {
			setZZ_AccreditationAuditNotifyLine_ID (0);
			setZZ_AccreditationAuditNotifyLine_UU (null);
        } */
    ...
    /** Standard Constructor */
    public X_ZZ_AccreditationAuditNotifyLine (Properties ctx, String ZZ_AccreditationAuditNotifyLine_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZ_AccreditationAuditNotifyLine_UU, trxName, virtualColumns);
      /** if (ZZ_AccreditationAuditNotifyLine_UU == null)
        {
			setZZ_AccreditationAuditNotifyLine_ID (0);
			setZZ_AccreditationAuditNotifyLine_UU (null);
    ...
    /** Load Constructor */
    public X_ZZ_AccreditationAuditNotifyLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_ZZ_AccreditationAuditNotifyLine[")
	...
	*/
	...
	/** Set Accreditation Audit Notifications Lines.
		@param ZZ_AccreditationAuditNotifyLine_ID Accreditation Audit Notifications Lines
	*/
	public void setZZ_AccreditationAuditNotifyLine_ID (int ZZ_AccreditationAuditNotifyLine_ID)
	{
		if (ZZ_AccreditationAuditNotifyLine_ID < 1)
			set_ValueNoCheck (COLUMNNAME_ZZ_AccreditationAuditNotifyLine_ID, null);
		else
			set_ValueNoCheck (COLUMNNAME_ZZ_AccreditationAuditNotifyLine_ID, Integer.valueOf(ZZ_AccreditationAuditNotifyLine_ID));
	}

	/** Get Accreditation Audit Notifications Lines.
		@return Accreditation Audit Notifications Lines	  */
	public int getZZ_AccreditationAuditNotifyLine_ID()
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_ZZ_AccreditationAuditNotifyLine_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set ZZ_AccreditationAuditNotifyLine_UU.
		@param ZZ_AccreditationAuditNotifyLine_UU ZZ_AccreditationAuditNotifyLine_UU
	*/
	public void setZZ_AccreditationAuditNotifyLine_UU (String ZZ_AccreditationAuditNotifyLine_UU)
	{
		set_ValueNoCheck (COLUMNNAME_ZZ_AccreditationAuditNotifyLine_UU, ZZ_AccreditationAuditNotifyLine_UU);
	}

	/** Get ZZ_AccreditationAuditNotifyLine_UU.
		@return ZZ_AccreditationAuditNotifyLine_UU	  */
	public String getZZ_AccreditationAuditNotifyLine_UU()
	{
		return (String)get_Value(COLUMNNAME_ZZ_AccreditationAuditNotifyLine_UU);
	}

	public I_ZZ_AccreditationAuditNotify getZZ_AccreditationAuditNotify() throws RuntimeException
	{
		return (I_ZZ_AccreditationAuditNotify)MTable.get(getCtx(), I_ZZ_AccreditationAuditNotify.Table_ID)
			.getPO(getZZ_AccreditationAuditNotify_ID(), get_TrxName());
	}

	/** Set ZZ_AccreditationAuditNotify_ID.
		@param ZZ_AccreditationAuditNotify_ID ZZ_AccreditationAuditNotify_ID
	*/
	public void setZZ_AccreditationAuditNotify_ID (int ZZ_AccreditationAuditNotify_ID)
	{
		if (ZZ_AccreditationAuditNotify_ID < 1)
			set_ValueNoCheck (COLUMNNAME_ZZ_AccreditationAuditNotify_ID, null);
		else
			set_ValueNoCheck (COLUMNNAME_ZZ_AccreditationAuditNotify_ID, Integer.valueOf(ZZ_AccreditationAuditNotify_ID));
	}

	/** Get ZZ_AccreditationAuditNotify_ID.
		@return ZZ_AccreditationAuditNotify_ID	  */
	public int getZZ_AccreditationAuditNotify_ID()
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_ZZ_AccreditationAuditNotify_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
