...
/** Generated Model for ZZQualification_v
 *  @author iDempiere (generated)
 *  @version Release 12 - $Id$ */
@org.adempiere.base.Model(table="ZZQualification_v")
public class X_ZZQualification_v extends PO implements I_ZZQualification_v, I_Persistent
{
...
// N
    ...
    /** Standard Constructor */
    public X_ZZQualification_v (Properties ctx, int ZZQualification_v_ID, String trxName, String ... virtualColumns)
    {
...
// N
    ...
    /** Standard Constructor */
    public X_ZZQualification_v (Properties ctx, String ZZQualification_v_UU, String trxName)
    {
...
// N
    ...
    /** Standard Constructor */
    public X_ZZQualification_v (Properties ctx, String ZZQualification_v_UU, String trxName, String ... virtualColumns)
    {
...
// N
    ...
    /** Load Constructor */
    public X_ZZQualification_v (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_ZZQualification_v[")
	...
	*/
	...
	/** Set Qualification View.
		@param ZZQualification_v_ID Qualification View
	*/
	public void setZZQualification_v_ID (int ZZQualification_v_ID)
	{
		if (ZZQualification_v_ID < 1)
			set_ValueNoCheck (COLUMNNAME_ZZQualification_v_ID, null);
		else
			set_ValueNoCheck (COLUMNNAME_ZZQualification_v_ID, Integer.valueOf(ZZQualification_v_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_ZZQualification_v_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set Qualification View UU.
		@param ZZQualification_v_UU Qualification View UU
	*/
	public void setZZQualification_v_UU (String ZZQualification_v_UU)
	{
		set_Value (COLUMNNAME_ZZQualification_v_UU, ZZQualification_v_UU);
	}

	/** Get Qualification View UU.
		@return Qualification View UU	  */
	public String getZZQualification_v_UU()
	{
		return (String)get_Value(COLUMNNAME_ZZQualification_v_UU);
	}
