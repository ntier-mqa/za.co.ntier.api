...
/** Generated Model for ZZ_WPA_App_QCTOQualifications
 *  @author iDempiere (generated)
 *  @version Release 12 - $Id$ */
@org.adempiere.base.Model(table="ZZ_WPA_App_QCTOQualifications")
public class X_ZZ_WPA_App_QCTOQualifications extends PO implements I_ZZ_WPA_App_QCTOQualifications, I_Persistent
{
    ...
    public X_ZZ_WPA_App_QCTOQualifications (Properties ctx, int ZZ_WPA_App_QCTOQualifications_ID, String trxName)
    {
      super (ctx, ZZ_WPA_App_QCTOQualifications_ID, trxName);
      /** if (ZZ_WPA_App_QCTOQualifications_ID == 0)
        {
        } */
    }

    /** Standard Constructor */
    public X_ZZ_WPA_App_QCTOQualifications (Properties ctx, int ZZ_WPA_App_QCTOQualifications_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZ_WPA_App_QCTOQualifications_ID, trxName, virtualColumns);
      /** if (ZZ_WPA_App_QCTOQualifications_ID == 0)
        {
        } */
    }
    ...
    /** Standard Constructor */
    public X_ZZ_WPA_App_QCTOQualifications (Properties ctx, String ZZ_WPA_App_QCTOQualifications_UU, String trxName)
    {
      super (ctx, ZZ_WPA_App_QCTOQualifications_UU, trxName);
      /** if (ZZ_WPA_App_QCTOQualifications_UU == null)
        {
        } */
    }

    /** Standard Constructor */
    public X_ZZ_WPA_App_QCTOQualifications (Properties ctx, String ZZ_WPA_App_QCTOQualifications_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZ_WPA_App_QCTOQualifications_UU, trxName, virtualColumns);
      /** if (ZZ_WPA_App_QCTOQualifications_UU == null)
        {
        } */
    }
    ...
    /** Load Constructor */
    public X_ZZ_WPA_App_QCTOQualifications (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_ZZ_WPA_App_QCTOQualifications[")
	...
	*/
	...
	/** Set QCTO Qualifications.
		@param ZZ_WPA_App_QCTOQualifications_ID QCTO Qualifications
	*/
	public void setZZ_WPA_App_QCTOQualifications_ID (int ZZ_WPA_App_QCTOQualifications_ID)
	{
		if (ZZ_WPA_App_QCTOQualifications_ID < 1)
			set_ValueNoCheck (COLUMNNAME_ZZ_WPA_App_QCTOQualifications_ID, null);
		else
			set_ValueNoCheck (COLUMNNAME_ZZ_WPA_App_QCTOQualifications_ID, Integer.valueOf(ZZ_WPA_App_QCTOQualifications_ID));
	}

	/** Get QCTO Qualifications.
		@return QCTO Qualifications	  */
	public int getZZ_WPA_App_QCTOQualifications_ID()
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_ZZ_WPA_App_QCTOQualifications_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set ZZ_WPA_App_QCTOQualifications_UU.
		@param ZZ_WPA_App_QCTOQualifications_UU ZZ_WPA_App_QCTOQualifications_UU
	*/
	public void setZZ_WPA_App_QCTOQualifications_UU (String ZZ_WPA_App_QCTOQualifications_UU)
	{
		set_ValueNoCheck (COLUMNNAME_ZZ_WPA_App_QCTOQualifications_UU, ZZ_WPA_App_QCTOQualifications_UU);
	}

	/** Get ZZ_WPA_App_QCTOQualifications_UU.
		@return ZZ_WPA_App_QCTOQualifications_UU	  */
	public String getZZ_WPA_App_QCTOQualifications_UU()
	{
		return (String)get_Value(COLUMNNAME_ZZ_WPA_App_QCTOQualifications_UU);
	}
