...
/** Generated Model for ZZSkillsProgramme_v
 *  @author iDempiere (generated)
 *  @version Release 12 - $Id$ */
@org.adempiere.base.Model(table="ZZSkillsProgramme_v")
public class X_ZZSkillsProgramme_v extends PO implements I_ZZSkillsProgramme_v, I_Persistent
{
    ...
    public X_ZZSkillsProgramme_v (Properties ctx, int ZZSkillsProgramme_v_ID, String trxName)
    {
      super (ctx, ZZSkillsProgramme_v_ID, trxName);
      /** if (ZZSkillsProgramme_v_ID == 0)
        {
        } */
    }

    /** Standard Constructor */
    public X_ZZSkillsProgramme_v (Properties ctx, int ZZSkillsProgramme_v_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZSkillsProgramme_v_ID, trxName, virtualColumns);
      /** if (ZZSkillsProgramme_v_ID == 0)
        {
        } */
    }
    ...
    /** Standard Constructor */
    public X_ZZSkillsProgramme_v (Properties ctx, String ZZSkillsProgramme_v_UU, String trxName)
    {
      super (ctx, ZZSkillsProgramme_v_UU, trxName);
      /** if (ZZSkillsProgramme_v_UU == null)
        {
        } */
    }

    /** Standard Constructor */
    public X_ZZSkillsProgramme_v (Properties ctx, String ZZSkillsProgramme_v_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZSkillsProgramme_v_UU, trxName, virtualColumns);
      /** if (ZZSkillsProgramme_v_UU == null)
        {
        } */
    }
    ...
    /** Load Constructor */
    public X_ZZSkillsProgramme_v (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_ZZSkillsProgramme_v[")
	...
	*/
	...
	/** Set Skills Programme View.
		@param ZZSkillsProgramme_v_ID Skills Programme View
	*/
	public void setZZSkillsProgramme_v_ID (int ZZSkillsProgramme_v_ID)
	{
		if (ZZSkillsProgramme_v_ID < 1)
			set_ValueNoCheck (COLUMNNAME_ZZSkillsProgramme_v_ID, null);
		else
			set_ValueNoCheck (COLUMNNAME_ZZSkillsProgramme_v_ID, Integer.valueOf(ZZSkillsProgramme_v_ID));
	}

	/** Get Skills Programme View.
		@return Skills Programme View	  */
	public int getZZSkillsProgramme_v_ID()
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_ZZSkillsProgramme_v_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set Skills Programme View UU.
		@param ZZSkillsProgramme_v_UU Skills Programme View UU
	*/
	public void setZZSkillsProgramme_v_UU (String ZZSkillsProgramme_v_UU)
	{
		set_ValueNoCheck (COLUMNNAME_ZZSkillsProgramme_v_UU, ZZSkillsProgramme_v_UU);
	}

	/** Get Skills Programme View UU.
		@return Skills Programme View UU	  */
	public String getZZSkillsProgramme_v_UU()
	{
		return (String)get_Value(COLUMNNAME_ZZSkillsProgramme_v_UU);
	}
}