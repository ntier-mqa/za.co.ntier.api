...
/** Generated Model for ZZ_QCTO_Alloc_OC
 *  @author iDempiere (generated)
 *  @version Release 12 - $Id$ */
@org.adempiere.base.Model(table="ZZ_QCTO_Alloc_OC")
public class X_ZZ_QCTO_Alloc_OC extends PO implements I_ZZ_QCTO_Alloc_OC, I_Persistent
{
    ...
    {
      super (ctx, ZZ_QCTO_Alloc_OC_ID, trxName);
      /** if (ZZ_QCTO_Alloc_OC_ID == 0)
        {
        } */
    }

    /** Standard Constructor */
    public X_ZZ_QCTO_Alloc_OC (Properties ctx, int ZZ_QCTO_Alloc_OC_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZ_QCTO_Alloc_OC_ID, trxName, virtualColumns);
      /** if (ZZ_QCTO_Alloc_OC_ID == 0)
        {
        } */
    }
    ...
    /** Standard Constructor */
    public X_ZZ_QCTO_Alloc_OC (Properties ctx, String ZZ_QCTO_Alloc_OC_UU, String trxName)
    {
      super (ctx, ZZ_QCTO_Alloc_OC_UU, trxName);
      /** if (ZZ_QCTO_Alloc_OC_UU == null)
        {
        } */
    }

    /** Standard Constructor */
    public X_ZZ_QCTO_Alloc_OC (Properties ctx, String ZZ_QCTO_Alloc_OC_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZ_QCTO_Alloc_OC_UU, trxName, virtualColumns);
      /** if (ZZ_QCTO_Alloc_OC_UU == null)
        {
        } */
    }
    ...
    /** Load Constructor */
    public X_ZZ_QCTO_Alloc_OC (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_ZZ_QCTO_Alloc_OC[")
	...
	*/
	...
	/** Set ZZ_QCTO_Alloc_OC_UU.
		@param ZZ_QCTO_Alloc_OC_UU ZZ_QCTO_Alloc_OC_UU
	*/
	public void setZZ_QCTO_Alloc_OC_UU (String ZZ_QCTO_Alloc_OC_UU)
	{
		set_ValueNoCheck (COLUMNNAME_ZZ_QCTO_Alloc_OC_UU, ZZ_QCTO_Alloc_OC_UU);
	}

	/** Get ZZ_QCTO_Alloc_OC_UU.
		@return ZZ_QCTO_Alloc_OC_UU	  */
	public String getZZ_QCTO_Alloc_OC_UU()
	{
		return (String)get_Value(COLUMNNAME_ZZ_QCTO_Alloc_OC_UU);
	}
