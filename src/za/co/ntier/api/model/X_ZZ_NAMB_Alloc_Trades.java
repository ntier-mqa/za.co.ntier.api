...
/** Generated Model for ZZ_NAMB_Alloc_Trades
 *  @author iDempiere (generated)
 *  @version Release 12 - $Id$ */
@org.adempiere.base.Model(table="ZZ_NAMB_Alloc_Trades")
public class X_ZZ_NAMB_Alloc_Trades extends PO implements I_ZZ_NAMB_Alloc_Trades, I_Persistent
{
    ...
    public X_ZZ_NAMB_Alloc_Trades (Properties ctx, int ZZ_NAMB_Alloc_Trades_ID, String trxName)
    {
      super (ctx, ZZ_NAMB_Alloc_Trades_ID, trxName);
      /** if (ZZ_NAMB_Alloc_Trades_ID == 0)
        {
...
// N
    ...
    /** Standard Constructor */
    public X_ZZ_NAMB_Alloc_Trades (Properties ctx, int ZZ_NAMB_Alloc_Trades_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZ_NAMB_Alloc_Trades_ID, trxName, virtualColumns);
      /** if (ZZ_NAMB_Alloc_Trades_ID == 0)
        {
			setIsOpenSchedule (false);
// N
    ...
    /** Standard Constructor */
    public X_ZZ_NAMB_Alloc_Trades (Properties ctx, String ZZ_NAMB_Alloc_Trades_UU, String trxName)
    {
      super (ctx, ZZ_NAMB_Alloc_Trades_UU, trxName);
      /** if (ZZ_NAMB_Alloc_Trades_UU == null)
        {
			setIsOpenSchedule (false);
// N
        } */
    ...
    /** Standard Constructor */
    public X_ZZ_NAMB_Alloc_Trades (Properties ctx, String ZZ_NAMB_Alloc_Trades_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZ_NAMB_Alloc_Trades_UU, trxName, virtualColumns);
      /** if (ZZ_NAMB_Alloc_Trades_UU == null)
        {
			setIsOpenSchedule (false);
// N
    ...
    /** Load Constructor */
    public X_ZZ_NAMB_Alloc_Trades (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_ZZ_NAMB_Alloc_Trades[")
	...
	*/
	...
	/** Set ZZ_NAMB_Alloc_Trades_UU.
		@param ZZ_NAMB_Alloc_Trades_UU ZZ_NAMB_Alloc_Trades_UU
	*/
	public void setZZ_NAMB_Alloc_Trades_UU (String ZZ_NAMB_Alloc_Trades_UU)
	{
		set_ValueNoCheck (COLUMNNAME_ZZ_NAMB_Alloc_Trades_UU, ZZ_NAMB_Alloc_Trades_UU);
	}

	/** Get ZZ_NAMB_Alloc_Trades_UU.
		@return ZZ_NAMB_Alloc_Trades_UU	  */
	public String getZZ_NAMB_Alloc_Trades_UU()
	{
		return (String)get_Value(COLUMNNAME_ZZ_NAMB_Alloc_Trades_UU);
	}
