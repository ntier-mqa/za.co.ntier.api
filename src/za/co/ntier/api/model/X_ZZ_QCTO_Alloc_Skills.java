...
/** Generated Model for ZZ_QCTO_Alloc_Skills
 *  @author iDempiere (generated)
 *  @version Release 12 - $Id$ */
@org.adempiere.base.Model(table="ZZ_QCTO_Alloc_Skills")
public class X_ZZ_QCTO_Alloc_Skills extends PO implements I_ZZ_QCTO_Alloc_Skills, I_Persistent
{
    ...
    public X_ZZ_QCTO_Alloc_Skills (Properties ctx, int ZZ_QCTO_Alloc_Skills_ID, String trxName)
    {
      super (ctx, ZZ_QCTO_Alloc_Skills_ID, trxName);
      /** if (ZZ_QCTO_Alloc_Skills_ID == 0)
        {
        } */
    }

    /** Standard Constructor */
    public X_ZZ_QCTO_Alloc_Skills (Properties ctx, int ZZ_QCTO_Alloc_Skills_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZ_QCTO_Alloc_Skills_ID, trxName, virtualColumns);
      /** if (ZZ_QCTO_Alloc_Skills_ID == 0)
        {
        } */
    }
    ...
    /** Standard Constructor */
    public X_ZZ_QCTO_Alloc_Skills (Properties ctx, String ZZ_QCTO_Alloc_Skills_UU, String trxName)
    {
      super (ctx, ZZ_QCTO_Alloc_Skills_UU, trxName);
      /** if (ZZ_QCTO_Alloc_Skills_UU == null)
        {
        } */
    }

    /** Standard Constructor */
    public X_ZZ_QCTO_Alloc_Skills (Properties ctx, String ZZ_QCTO_Alloc_Skills_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZ_QCTO_Alloc_Skills_UU, trxName, virtualColumns);
      /** if (ZZ_QCTO_Alloc_Skills_UU == null)
        {
        } */
    }
    ...
    /** Load Constructor */
    public X_ZZ_QCTO_Alloc_Skills (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_ZZ_QCTO_Alloc_Skills[")
	...
	*/
	...
	/** Set Trading Name.
		@param ZZTradeName Trading Name
	*/
	...
	*/
	...
	/** Set ZZ_QCTO_Alloc_Skills_UU.
		@param ZZ_QCTO_Alloc_Skills_UU ZZ_QCTO_Alloc_Skills_UU
	*/
	public void setZZ_QCTO_Alloc_Skills_UU (String ZZ_QCTO_Alloc_Skills_UU)
	{
		set_ValueNoCheck (COLUMNNAME_ZZ_QCTO_Alloc_Skills_UU, ZZ_QCTO_Alloc_Skills_UU);
	}

	/** Get ZZ_QCTO_Alloc_Skills_UU.
		@return ZZ_QCTO_Alloc_Skills_UU	  */
	public String getZZ_QCTO_Alloc_Skills_UU()
	{
		return (String)get_Value(COLUMNNAME_ZZ_QCTO_Alloc_Skills_UU);
	}
