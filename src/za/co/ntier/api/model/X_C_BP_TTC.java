...
/** Generated Model for C_BP_TTC
 *  @author iDempiere (generated)
 *  @version Release 12 - $Id$ */
@org.adempiere.base.Model(table="C_BP_TTC")
public class X_C_BP_TTC extends PO implements I_C_BP_TTC, I_Persistent
{
    ...
    public X_C_BP_TTC (Properties ctx, int C_BP_TTC_ID, String trxName)
    {
      super (ctx, C_BP_TTC_ID, trxName);
      /** if (C_BP_TTC_ID == 0)
        {
			setZZ_AccreditationNumber (null);
        } */
    }

    /** Standard Constructor */
    public X_C_BP_TTC (Properties ctx, int C_BP_TTC_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, C_BP_TTC_ID, trxName, virtualColumns);
      /** if (C_BP_TTC_ID == 0)
        {
			setZZ_AccreditationNumber (null);
        } */
    ...
    /** Standard Constructor */
    public X_C_BP_TTC (Properties ctx, String C_BP_TTC_UU, String trxName)
    {
      super (ctx, C_BP_TTC_UU, trxName);
      /** if (C_BP_TTC_UU == null)
        {
			setZZ_AccreditationNumber (null);
        } */
    ...
    /** Standard Constructor */
    public X_C_BP_TTC (Properties ctx, String C_BP_TTC_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, C_BP_TTC_UU, trxName, virtualColumns);
      /** if (C_BP_TTC_UU == null)
        {
			setZZ_AccreditationNumber (null);
        } */
    ...
    /** Load Constructor */
    public X_C_BP_TTC (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_C_BP_TTC[")
        .append(get_ID()).append("]");
      return sb.toString();
    }

	/** Set TTC.
		@param C_BP_TTC_ID TTC
	*/
	public void setC_BP_TTC_ID (int C_BP_TTC_ID)
	{
		if (C_BP_TTC_ID < 1)
			set_ValueNoCheck (COLUMNNAME_C_BP_TTC_ID, null);
		else
			set_ValueNoCheck (COLUMNNAME_C_BP_TTC_ID, Integer.valueOf(C_BP_TTC_ID));
	}

	/** Get TTC.
		@return TTC	  */
	public int getC_BP_TTC_ID()
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_BP_TTC_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set C_BP_TTC_UU.
		@param C_BP_TTC_UU C_BP_TTC_UU
	*/
	public void setC_BP_TTC_UU (String C_BP_TTC_UU)
	{
		set_ValueNoCheck (COLUMNNAME_C_BP_TTC_UU, C_BP_TTC_UU);
	}

	/** Get C_BP_TTC_UU.
		@return C_BP_TTC_UU	  */
	public String getC_BP_TTC_UU()
	{
		return (String)get_Value(COLUMNNAME_C_BP_TTC_UU);
	}
