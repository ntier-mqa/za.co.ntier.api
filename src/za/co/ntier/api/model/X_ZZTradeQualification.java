...
/** Generated Model for ZZTradeQualification
 *  @author iDempiere (generated)
 *  @version Release 12 - $Id$ */
@org.adempiere.base.Model(table="ZZTradeQualification")
public class X_ZZTradeQualification extends PO implements I_ZZTradeQualification, I_Persistent
{
    ...
    public X_ZZTradeQualification (Properties ctx, int ZZTradeQualification_ID, String trxName)
    {
      super (ctx, ZZTradeQualification_ID, trxName);
      /** if (ZZTradeQualification_ID == 0)
        {
			setZZTradeQualification_ID (0);
        } */
    }

    /** Standard Constructor */
    public X_ZZTradeQualification (Properties ctx, int ZZTradeQualification_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZTradeQualification_ID, trxName, virtualColumns);
      /** if (ZZTradeQualification_ID == 0)
        {
			setZZTradeQualification_ID (0);
        } */
    ...
    /** Standard Constructor */
    public X_ZZTradeQualification (Properties ctx, String ZZTradeQualification_UU, String trxName)
    {
      super (ctx, ZZTradeQualification_UU, trxName);
      /** if (ZZTradeQualification_UU == null)
        {
			setZZTradeQualification_ID (0);
        } */
    }
    ...
    /** Standard Constructor */
    public X_ZZTradeQualification (Properties ctx, String ZZTradeQualification_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZTradeQualification_UU, trxName, virtualColumns);
      /** if (ZZTradeQualification_UU == null)
        {
			setZZTradeQualification_ID (0);
        } */
    ...
    /** Load Constructor */
    public X_ZZTradeQualification (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_ZZTradeQualification[")
	...
	*/
	...
	{
		set_Value (COLUMNNAME_ZZCode, ZZCode);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_ZZCode);
	}
	...
	*/
    ...
    {
        return new KeyNamePair(get_ID(), getZZTitle());
    }
	...
	*/
	...
	/** Set ZZTradeQualification_UU.
		@param ZZTradeQualification_UU ZZTradeQualification_UU
	*/
	public void setZZTradeQualification_UU (String ZZTradeQualification_UU)
	{
		set_Value (COLUMNNAME_ZZTradeQualification_UU, ZZTradeQualification_UU);
	}

	/** Get ZZTradeQualification_UU.
		@return ZZTradeQualification_UU	  */
	public String getZZTradeQualification_UU()
	{
		return (String)get_Value(COLUMNNAME_ZZTradeQualification_UU);
	}
}