...
/** Generated Model for ZZQctoSkillsProgramme
 *  @author iDempiere (generated)
 *  @version Release 12 - $Id$ */
@org.adempiere.base.Model(table="ZZQctoSkillsProgramme")
public class X_ZZQctoSkillsProgramme extends PO implements I_ZZQctoSkillsProgramme, I_Persistent
{
    ...
    public X_ZZQctoSkillsProgramme (Properties ctx, int ZZQctoSkillsProgramme_ID, String trxName)
    {
      ...
      /** if (ZZQctoSkillsProgramme_ID == 0)
        {
			setZZQctoSkillsProgramme_ID (0);
        } */
    }

    /** Standard Constructor */
    public X_ZZQctoSkillsProgramme (Properties ctx, int ZZQctoSkillsProgramme_ID, String trxName, String ... virtualColumns)
    {
    ...
    /** Standard Constructor */
    public X_ZZQctoSkillsProgramme (Properties ctx, String ZZQctoSkillsProgramme_UU, String trxName)
    {
      super (ctx, ZZQctoSkillsProgramme_UU, trxName);
      /** if (ZZQctoSkillsProgramme_UU == null)
        {
			setZZQctoSkillsProgramme_ID (0);
        } */
    }
    ...
    /** Standard Constructor */
    public X_ZZQctoSkillsProgramme (Properties ctx, String ZZQctoSkillsProgramme_UU, String trxName, String ... virtualColumns)
    {
    ...
    /** Load Constructor */
    public X_ZZQctoSkillsProgramme (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_ZZQctoSkillsProgramme[")
	...
	*/
	...
	/** Set ZZQctoSkillsProgramme_UU.
		@param ZZQctoSkillsProgramme_UU ZZQctoSkillsProgramme_UU
	*/
	public void setZZQctoSkillsProgramme_UU (String ZZQctoSkillsProgramme_UU)
	{
		set_Value (COLUMNNAME_ZZQctoSkillsProgramme_UU, ZZQctoSkillsProgramme_UU);
	}

	/** Get ZZQctoSkillsProgramme_UU.
		@return ZZQctoSkillsProgramme_UU	  */
	public String getZZQctoSkillsProgramme_UU()
	{
		return (String)get_Value(COLUMNNAME_ZZQctoSkillsProgramme_UU);
	}
