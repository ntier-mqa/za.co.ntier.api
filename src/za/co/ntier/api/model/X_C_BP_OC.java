...
/** Generated Model for C_BP_OC
 *  @author iDempiere (generated)
 *  @version Release 12 - $Id$ */
@org.adempiere.base.Model(table="C_BP_OC")
public class X_C_BP_OC extends PO implements I_C_BP_OC, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_C_BP_OC (Properties ctx, int C_BP_OC_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, C_BP_OC_ID, trxName, virtualColumns);
      /** if (C_BP_OC_ID == 0)
        {
        } */
    }
    ...
    /** Standard Constructor */
    public X_C_BP_OC (Properties ctx, String C_BP_OC_UU, String trxName)
    {
      super (ctx, C_BP_OC_UU, trxName);
      /** if (C_BP_OC_UU == null)
        {
        } */
    }
    ...
    /** Standard Constructor */
    public X_C_BP_OC (Properties ctx, String C_BP_OC_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, C_BP_OC_UU, trxName, virtualColumns);
      /** if (C_BP_OC_UU == null)
        {
        } */
    }
    ...
    /** Load Constructor */
    public X_C_BP_OC (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_C_BP_OC[")
	...
	*/
	...
	/** Set C_BP_OC_UU.
		@param C_BP_OC_UU C_BP_OC_UU
	*/
	public void setC_BP_OC_UU (String C_BP_OC_UU)
	{
		set_ValueNoCheck (COLUMNNAME_C_BP_OC_UU, C_BP_OC_UU);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_C_BP_OC_UU);
	}
