...
/** Generated Model for ZZ_AccreditationAuditNotify
 *  @author iDempiere (generated)
 *  @version Release 12 - $Id$ */
@org.adempiere.base.Model(table="ZZ_AccreditationAuditNotify")
public class X_ZZ_AccreditationAuditNotify extends PO implements I_ZZ_AccreditationAuditNotify, I_Persistent
{
    ...
    public X_ZZ_AccreditationAuditNotify (Properties ctx, int ZZ_AccreditationAuditNotify_ID, String trxName)
    {
      super (ctx, ZZ_AccreditationAuditNotify_ID, trxName);
      /** if (ZZ_AccreditationAuditNotify_ID == 0)
        {
			setZZ_AccreditationAuditNotify_ID (0);
			setZZ_AccreditationAuditNotify_UU (null);
        } */
    }

    /** Standard Constructor */
    public X_ZZ_AccreditationAuditNotify (Properties ctx, int ZZ_AccreditationAuditNotify_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZ_AccreditationAuditNotify_ID, trxName, virtualColumns);
      /** if (ZZ_AccreditationAuditNotify_ID == 0)
        {
			setZZ_AccreditationAuditNotify_ID (0);
			setZZ_AccreditationAuditNotify_UU (null);
    ...
    /** Standard Constructor */
    public X_ZZ_AccreditationAuditNotify (Properties ctx, String ZZ_AccreditationAuditNotify_UU, String trxName)
    {
      super (ctx, ZZ_AccreditationAuditNotify_UU, trxName);
      /** if (ZZ_AccreditationAuditNotify_UU == null)
        {
			setZZ_AccreditationAuditNotify_ID (0);
			setZZ_AccreditationAuditNotify_UU (null);
        } */
    ...
    /** Standard Constructor */
    public X_ZZ_AccreditationAuditNotify (Properties ctx, String ZZ_AccreditationAuditNotify_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZ_AccreditationAuditNotify_UU, trxName, virtualColumns);
      /** if (ZZ_AccreditationAuditNotify_UU == null)
        {
			setZZ_AccreditationAuditNotify_ID (0);
			setZZ_AccreditationAuditNotify_UU (null);
    ...
    /** Load Constructor */
    public X_ZZ_AccreditationAuditNotify (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_ZZ_AccreditationAuditNotify[")
	...
	*/
	...
	/** Set ZZ_AccreditationAuditNotify_UU.
		@param ZZ_AccreditationAuditNotify_UU ZZ_AccreditationAuditNotify_UU
	*/
	public void setZZ_AccreditationAuditNotify_UU (String ZZ_AccreditationAuditNotify_UU)
	{
		set_ValueNoCheck (COLUMNNAME_ZZ_AccreditationAuditNotify_UU, ZZ_AccreditationAuditNotify_UU);
	}

	/** Get ZZ_AccreditationAuditNotify_UU.
		@return ZZ_AccreditationAuditNotify_UU	  */
	public String getZZ_AccreditationAuditNotify_UU()
	{
		return (String)get_Value(COLUMNNAME_ZZ_AccreditationAuditNotify_UU);
	}
