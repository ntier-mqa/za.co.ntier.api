...
/** Generated Model for ZZArtisans
 *  @author iDempiere (generated)
 *  @version Release 12 - $Id$ */
@org.adempiere.base.Model(table="ZZArtisans")
public class X_ZZArtisans extends PO implements I_ZZArtisans, I_Persistent
{
    ...
    public X_ZZArtisans (Properties ctx, int ZZArtisans_ID, String trxName)
    {
      super (ctx, ZZArtisans_ID, trxName);
      /** if (ZZArtisans_ID == 0)
        {
			setZZArtisans_ID (0);
        } */
    ...
    /** Standard Constructor */
    public X_ZZArtisans (Properties ctx, int ZZArtisans_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZArtisans_ID, trxName, virtualColumns);
      /** if (ZZArtisans_ID == 0)
        {
			setZZArtisans_ID (0);
        } */
    ...
    /** Standard Constructor */
    public X_ZZArtisans (Properties ctx, String ZZArtisans_UU, String trxName)
    {
      super (ctx, ZZArtisans_UU, trxName);
      /** if (ZZArtisans_UU == null)
        {
			setZZArtisans_ID (0);
        } */
    }
    ...
    /** Standard Constructor */
    public X_ZZArtisans (Properties ctx, String ZZArtisans_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZArtisans_UU, trxName, virtualColumns);
      /** if (ZZArtisans_UU == null)
        {
			setZZArtisans_ID (0);
        } */
    ...
    /** Load Constructor */
    public X_ZZArtisans (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_ZZArtisans[")
	...
	*/
	...
	/** Set Artisan Code.
		@param ZZArtisanCode Artisan Code
	*/
	public void setZZArtisanCode (String ZZArtisanCode)
	{
		set_Value (COLUMNNAME_ZZArtisanCode, ZZArtisanCode);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_ZZArtisanCode);
	}

	/** Set Artisan Title.
		@param ZZArtisanTitle Artisan Title
	*/
	public void setZZArtisanTitle (String ZZArtisanTitle)
	{
		set_Value (COLUMNNAME_ZZArtisanTitle, ZZArtisanTitle);
	}

	/** Get Artisan Title.
		@return Artisan Title	  */
	public String getZZArtisanTitle()
	{
		return (String)get_Value(COLUMNNAME_ZZArtisanTitle);
	}
    ...
    {
        return new KeyNamePair(get_ID(), getZZArtisanTitle());
    }

	/** Apprenticeship = Apprenticeship */
	public static final String ZZARTISANTYPE_Apprenticeship = "Apprenticeship";
	/** Learnership Apprenticeship = Learnership Apprenticeship */
	public static final String ZZARTISANTYPE_LearnershipApprenticeship = "Learnership Apprenticeship";
	/** Set Artisan Type.
		@param ZZArtisanType Artisan Type
	*/
	public void setZZArtisanType (String ZZArtisanType)
	{

		set_Value (COLUMNNAME_ZZArtisanType, ZZArtisanType);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_ZZArtisanType);
	}

	/** Set Artisans.
		@param ZZArtisans_ID Artisans
	*/
	public void setZZArtisans_ID (int ZZArtisans_ID)
	{
		if (ZZArtisans_ID < 1)
			set_ValueNoCheck (COLUMNNAME_ZZArtisans_ID, null);
		else
			set_ValueNoCheck (COLUMNNAME_ZZArtisans_ID, Integer.valueOf(ZZArtisans_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_ZZArtisans_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set ZZArtisans_UU.
		@param ZZArtisans_UU ZZArtisans_UU
	*/
	public void setZZArtisans_UU (String ZZArtisans_UU)
	{
		set_Value (COLUMNNAME_ZZArtisans_UU, ZZArtisans_UU);
	}

	/** Get ZZArtisans_UU.
		@return ZZArtisans_UU	  */
	public String getZZArtisans_UU()
	{
		return (String)get_Value(COLUMNNAME_ZZArtisans_UU);
	}

	/** ZZCanCompleteBefore18 AD_Reference_ID=319 */
	public static final int ZZCANCOMPLETEBEFORE18_AD_Reference_ID=319;
	/** No = N */
	public static final String ZZCANCOMPLETEBEFORE18_No = "N";
	/** Yes = Y */
	public static final String ZZCANCOMPLETEBEFORE18_Yes = "Y";
	/** Set Can Complete Before 18.
		@param ZZCanCompleteBefore18 Can Complete Before 18
	*/
	public void setZZCanCompleteBefore18 (String ZZCanCompleteBefore18)
	{

		set_Value (COLUMNNAME_ZZCanCompleteBefore18, ZZCanCompleteBefore18);
	}

	/** Get Can Complete Before 18.
		@return Can Complete Before 18	  */
	public String getZZCanCompleteBefore18()
	{
		return (String)get_Value(COLUMNNAME_ZZCanCompleteBefore18);
	}

	/** ZZIsTvetncv AD_Reference_ID=319 */
	public static final int ZZISTVETNCV_AD_Reference_ID=319;
	/** No = N */
	public static final String ZZISTVETNCV_No = "N";
	/** Yes = Y */
	public static final String ZZISTVETNCV_Yes = "Y";
	/** Set TVET-NCV.
		@param ZZIsTvetncv TVET-NCV
	*/
	public void setZZIsTvetncv (String ZZIsTvetncv)
	{

		set_Value (COLUMNNAME_ZZIsTvetncv, ZZIsTvetncv);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_ZZIsTvetncv);
	}
	...
	*/
	...
	{
		return (I_ZZTradeQualification)MTable.get(getCtx(), I_ZZTradeQualification.Table_ID)
			.getPO(getZZTradeQualification_ID(), get_TrxName());
	}

	/** Set Trade Qualification.
		@param ZZTradeQualification_ID Trade Qualification
	*/
	public void setZZTradeQualification_ID (int ZZTradeQualification_ID)
	{
		if (ZZTradeQualification_ID < 1)
			set_ValueNoCheck (COLUMNNAME_ZZTradeQualification_ID, null);
		else
			set_ValueNoCheck (COLUMNNAME_ZZTradeQualification_ID, Integer.valueOf(ZZTradeQualification_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_ZZTradeQualification_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
