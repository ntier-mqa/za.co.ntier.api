...
public class X_ZZAssessorPerson_v extends PO implements I_ZZAssessorPerson_v, I_Persistent
{
	...
	*/
	...
	/** Set ZZAssessorPerson_v_UU.
		@param ZZAssessorPerson_v_UU ZZAssessorPerson_v_UU
	*/
	...
	/** Get ZZAssessorPerson_v_UU.
		@return ZZAssessorPerson_v_UU	  */
	...
	*/
	public void setZZ_ApprovedBy_ID (int ZZ_ApprovedBy_ID)
	{
		if (ZZ_ApprovedBy_ID < 1)
			set_ValueNoCheck (COLUMNNAME_ZZ_ApprovedBy_ID, null);
		else
			set_ValueNoCheck (COLUMNNAME_ZZ_ApprovedBy_ID, Integer.valueOf(ZZ_ApprovedBy_ID));
	}
	...
	*/
	...
	{
		set_ValueNoCheck (COLUMNNAME_ZZ_ApprovedDate, ZZ_ApprovedDate);
	}
	...
	*/
	...
	{
		set_ValueNoCheck (COLUMNNAME_ZZ_Assessor, ZZ_Assessor);
	}
	...
	*/
	...
	{
		set_ValueNoCheck (COLUMNNAME_ZZ_Date_Not_Approved, ZZ_Date_Not_Approved);
	}
	...
	*/
	...
	{
		set_ValueNoCheck (COLUMNNAME_ZZ_Date_Not_Recommended, ZZ_Date_Not_Recommended);
	}
	...
	*/
	...
	{
		set_ValueNoCheck (COLUMNNAME_ZZ_Date_Recommended, ZZ_Date_Recommended);
	}
	...
	*/
	public void setZZ_Recommender_ID (int ZZ_Recommender_ID)
	{
		if (ZZ_Recommender_ID < 1)
			set_ValueNoCheck (COLUMNNAME_ZZ_Recommender_ID, null);
		else
			set_ValueNoCheck (COLUMNNAME_ZZ_Recommender_ID, Integer.valueOf(ZZ_Recommender_ID));
	}
